using System;
using LibraryInterfacePerformance.StructuresToStaticGenericMethodsByInterfaces.Library;

namespace LibraryInterfacePerformance.StructuresToStaticGenericMethodsByInterfaces.Consumer
{
