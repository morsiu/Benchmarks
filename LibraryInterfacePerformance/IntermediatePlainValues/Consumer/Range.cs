using System;
using LibraryInterfacePerformance.IntermediatePlainValues.Library;

namespace LibraryInterfacePerformance.IntermediatePlainValues.Consumer
{
        ...
        where T : IComparable<T>
    {
        ...
        {
            return RangeOperations.Intersect(
                    Start, OpenStart, End, OpenEnd,
                    other.Start, other.OpenStart, other.End, other.OpenEnd,
