using System;
using LibraryInterfacePerformance.GenericsAndInterfacesRefAndReturn.Library;

namespace LibraryInterfacePerformance.GenericsAndInterfacesRefAndReturn.Consumer
{
